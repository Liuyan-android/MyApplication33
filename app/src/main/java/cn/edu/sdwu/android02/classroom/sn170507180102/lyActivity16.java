...
public class lyActivity16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateCallback = new CameraDevice.StateCallback() {
            ...
            public void onOpened(@NonNull CameraDevice cameraDevice) {
                ...
                lyActivity16.this.cameraDevice = cameraDevice;
                //准备预览时使用的组件
                ...
                try {
                    ...
                    imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader imageReader) {
                            ...
                            try{
                                ...
                                Toast.makeText(lyActivity16.this,"save:"+file,Toast.LENGTH_LONG).show();
                            }catch (Exception e){
                                Log.e(ly16Activity.class.toString(), e.toString());
                            }finally {
                                try{
                                    ...
                                    Log.e(ly16Activity.class.toString(), ee.toString()) ;
                                }
                            }
                    ...
                    cameraDevice.createCaptureSession(Arrays.asList(surface,imageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            //开始显示相机的预览
                            lyActivity16.this.cameraCaptureSession = cameraCaptureSession;
                            try {
            ...
            public void onDisconnected(@NonNull CameraDevice cameraDevice) {
                lyActivity16.this.cameraDevice=null;
            }
    ...
    private void setCameraLayout(){
        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
                ...
                lyActivity16.this.surfaceTexture=surfaceTexture;
    ...
    private  void sendSms(){
        ...
        smsManager.sendTextMessage("13395311130","13399997777","short message test",null,null);
    }
