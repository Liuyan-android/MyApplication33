...
public class MyContentProvider extends ContentProvider {
    ...
    public static final String MIME_MAINTYPE_DIR = "vnd.android.cursor.dir";//多条数据
    public static final String MIME_MAINTYPE_ITEM = "vnd.android.cursor.item";//单条数据
    ...
    @Override
    public String getType(Uri uri) {//返回数据的类型
        // TODO: Implement this to handle requests for the MIME type of the data
        // at the given URI.
        //返回共享数据MIME的类型
        //通过uri数据，利用uriMatcher判断是单条数据还是多条数据
    ...
    @Override
    public Cursor query(Uri uri, String[] projection, String selection,//查询
